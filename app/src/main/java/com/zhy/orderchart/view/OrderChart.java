package com.zhy.orderchart.view;
...
import com.zhy.libutils.DataUtil;
import com.zhy.orderchart.R;
...
public class OrderChart extends View {
    ...
    public OrderChart(Context context) {
        this(context, null);
    }

    public OrderChart(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OrderChart(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initXmlAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.OrderChart);
        if (typedArray == null) return;
        bidColor = typedArray.getColor(R.styleable.OrderChart_bid_color, getResources().getColor(R.color.red_f06256));
        askColor = typedArray.getColor(R.styleable.OrderChart_ask_color, getResources().getColor(R.color.green_3cc28a));
        virtualLineColor = typedArray.getColor(R.styleable.OrderChart_line_virtual_color, getResources().getColor(R.color.black));
        curPriceTxtColor = typedArray.getColor(R.styleable.OrderChart_text_current_price_color, getResources().getColor(R.color.white));
        scaleTextColor = typedArray.getColor(R.styleable.OrderChart_text_scale_color, getResources().getColor(R.color.black));
        showPointNums = typedArray.getInt(R.styleable.OrderChart_price_point_nums, 35);
        yScaleDataWidth = typedArray.getDimension(R.styleable.OrderChart_scale_width_y, 150);
        dataPaddingTop = typedArray.getDimension(R.styleable.OrderChart_oc_padding_top, 50);
        dataPaddingLeft = typedArray.getDimension(R.styleable.OrderChart_oc_padding_left, 30);
        dataPaddingRight = typedArray.getDimension(R.styleable.OrderChart_oc_padding_right, 30);
        dataPaddingBottom = typedArray.getDimension(R.styleable.OrderChart_oc_padding_bottom, 50);
        textSize = typedArray.getInteger(R.styleable.OrderChart_oc_text_size, 35);
        typedArray.recycle();
    }
